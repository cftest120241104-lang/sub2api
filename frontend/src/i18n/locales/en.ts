export default {
  ...
  admin: {
    ...
    gameService: {
      title: 'Game Service',
      description: 'Connect to pragmaticplay_games/server for health checks, test sessions, and GM scenarios',
      health: 'Health',
      readiness: 'Readiness',
      ready: 'Ready',
      notReady: 'Not Ready',
      currentSession: 'Current Test Session',
      noSession: 'No session created',
      createSessionHint: 'Create a session before loading GM scenarios',
      ...
      gmScenarios: 'GM Scenarios',
      currentScenario: 'Current scenario: {id}',
      scenarioHint: 'Create a test session before loading scenarios',
      loadScenarios: 'Load Scenarios',
      noScenarioData: 'No scenario data',
      protocolTest: 'Protocol Test',
      protocolDescription: 'Run basic Pragmatic gameService actions and inspect returned fields',
      doInit: 'Init',
      doSpin: 'Spin',
      doCollect: 'Collect',
      coin: 'Coin',
      lines: 'Lines',
      roundId: 'Round ID',
      regenerateRoundId: 'Regenerate round ID',
      lastProtocol: 'Last Protocol Response',
      noProtocolOutput: 'No protocol response yet',
      sessionRequired: 'Create a test session first',
      statusFailed: 'Failed to load game service status',
      sessionCreated: 'Test session created',
      sessionCreateFailed: 'Failed to create test session',
      scenarioLoadFailed: 'Failed to load GM scenarios',
      scenarioSet: 'GM scenario updated',
      scenarioSetFailed: 'Failed to update GM scenario',
      protocolFailed: 'Protocol action failed'
    },
