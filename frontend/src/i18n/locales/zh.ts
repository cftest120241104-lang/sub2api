export default {
  ...
  admin: {
    ...
    gameService: {
      title: '游戏服务',
      description: '对接 pragmaticplay_games/server，管理健康状态、测试会话和 GM 场景',
      health: '健康检查',
      readiness: '就绪检查',
      ready: '就绪',
      notReady: '未就绪',
      ...
      noSession: '尚未创建会话',
      createSessionHint: '创建会话后可读取和切换 GM 场景',
      testSession: '测试会话',
      channelCode: '渠道代码',
      gameCode: '游戏代码',
      playerId: '玩家 ID',
      ...
      createSession: '创建会话',
      gmScenarios: 'GM 场景',
      currentScenario: '当前场景：{id}',
      scenarioHint: '先创建测试会话，再加载场景',
      loadScenarios: '加载场景',
      noScenarioData: '暂无场景数据',
      protocolTest: '协议测试',
      protocolDescription: '执行 Pragmatic gameService 基础动作，查看返回字段',
      doInit: '初始化',
      doSpin: '旋转',
      doCollect: '收分',
      coin: '单注金额',
      lines: '线数',
      roundId: '局 ID',
      regenerateRoundId: '重新生成局 ID',
      lastProtocol: '最近协议响应',
      noProtocolOutput: '暂无协议响应',
      sessionRequired: '请先创建测试会话',
      statusFailed: '游戏服务状态加载失败',
      sessionCreated: '测试会话已创建',
      sessionCreateFailed: '测试会话创建失败',
      scenarioLoadFailed: 'GM 场景加载失败',
      scenarioSet: 'GM 场景已切换',
      scenarioSetFailed: 'GM 场景切换失败',
      protocolFailed: '协议动作执行失败'
    },
